...
import { Mail, Lock, Eye, EyeOff, Loader2, Sparkles, User, Check, CheckCircle, ArrowLeft } from "lucide-react"
// Check 图标仍用于密码匹配显示
...
export default function RegisterClient({ redirectTo }: RegisterClientProps) {
          ...
          {awaitingVerification ? (
            <div className="text-center py-4">
              ...
              <p className="text-zinc-400 mb-6">
                已发送验证邮件到{" "}
                <span className="text-purple-400">{submittedEmail || email}</span>，请验证后再登录
              </p>
              <Link
                href={loginHref}
