...
export async function POST(request: NextRequest) {
  ...
  const prompt = getTextField(requestBody, ["prompt", "coverPrompt", "cover_prompt"])
  const negativePrompt = getTextField(requestBody, ["negativePrompt", "coverNegative", "cover_negative"])
