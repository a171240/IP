...
- currentEvidence: inventory.rdsPostgres=observed_or_unknown; rdsLocalExists=true; rdsLocalReady=false; appApiRoutesWithSupabase=31/31; firstVersionRdsRoutesWithSupabaseDataAccess=19/25; postgresDataAccessAdapterDetected=true
