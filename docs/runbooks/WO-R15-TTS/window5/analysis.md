# WO-R15-TTS (window5) Analysis

## Scope
- Goal: keep TTS cache and replay behavior stable.
- Code change: none (docs evidence only).
...
- G3 PASS: B/C and replay aggregate all have `runtime=0` and `llm_used_when_script_hit_count=0`.
