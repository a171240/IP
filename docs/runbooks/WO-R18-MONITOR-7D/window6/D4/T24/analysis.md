...
## Metrics
- B: audio_ready_ms_p95=4742, asr_provider_distribution={"flash":1}, submit_pump_count=0, events_pump_count=0, executor_worker_ratio=1
- C: audio_ready_ms_p95=10071, asr_provider_distribution={"auc":1}, path_mode=slow_path_degraded
