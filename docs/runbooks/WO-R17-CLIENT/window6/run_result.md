# WO-R17-CLIENT/window6 One-Click Result

- generated_at: 2026-02-24T09:12:17.294Z
- status: PASS
...
- G3: PASS (c_long_tail_buckets_complete=true, audio_ready_ms_C_p95=4689, queue_wait_before_main_ms_C_p95=0, queue_wait_before_tts_ms_C_p95=1, queue_wait_before_main_ms_p95=0, queue_wait_before_tts_ms_p95=2)
...
- success_rounds.audio_ready_ms_p95: 4689
- success_rounds.queue_wait_before_main_ms_p95: 0
- success_rounds.queue_wait_before_tts_ms_p95: 1

## Outputs
- bench_A: `/Users/zhuan/IP项目/ip-content-factory/docs/runbooks/WO-R17-CLIENT/window6/bench_A.json`
- bench_B: `/Users/zhuan/IP项目/ip-content-factory/docs/runbooks/WO-R17-CLIENT/window6/bench_B.json`
- bench_C: `/Users/zhuan/IP项目/ip-content-factory/docs/runbooks/WO-R17-CLIENT/window6/bench_C.json`
- C.json: `/Users/zhuan/IP项目/ip-content-factory/docs/runbooks/WO-R17-CLIENT/window6/C.json`
- analysis.json: `/Users/zhuan/IP项目/ip-content-factory/docs/runbooks/WO-R17-CLIENT/window6/analysis.json`
- analysis.md: `/Users/zhuan/IP项目/ip-content-factory/docs/runbooks/WO-R17-CLIENT/window6/analysis.md`
