# WO-R11-WORKER-R3/window4-rerun7 Analysis

## Scope
- Metrics-calibration and audit rollup only (`scripts/*`, `docs/runbooks/*`).

## Inputs
- bench_A: `/Users/zhuan/IP项目/ip-content-factory/docs/runbooks/WO-R11-WORKER-R3/window4-rerun7/bench_A.json`
- bench_B: `/Users/zhuan/IP项目/ip-content-factory/docs/runbooks/WO-R11-WORKER-R3/window4-rerun7/bench_B.json`
- bench_C: `/Users/zhuan/IP项目/ip-content-factory/docs/runbooks/WO-R11-WORKER-R3/window4-rerun7/bench_C.json`
...
- submit_ack_ms: 5647/6260
- asr_ready_ms: 3832/4137
- text_ready_ms: 5000/5420
- audio_ready_ms: 5728/6020
- queue_wait_before_main_ms: 0/115
- queue_wait_before_tts_ms: 0/0

## Group Notes
- A: require_flash=true, pass=true
- B: flash_primary, audio_ready_ms_p50=5847
...
- success_rounds(audio_ready_ms): 5723/6020
- success_rounds(queue_wait_before_main_ms): 84/115
...
- G1: PASS: audio_ready_ms_B_p50=5847 target<=8000
