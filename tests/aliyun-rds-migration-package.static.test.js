...
test("Aliyun RDS migration package generates non-secret SQL and validation artifacts", () => {
  ...
  assert.equal(report.summary.sourceFileCount, 11)
...
test("tracked Aliyun RDS migration package handoff pins non-secret package digests", () => {
  ...
  assert.match(doc, /sourceFileCount: 11/)
  assert.match(doc, /requiredTableCount: 17/)
  assert.match(doc, /requiredFunctionCount: 0/)
  assert.match(doc, /requiredStorageCount: 1/)
  assert.match(doc, /schemaSqlSha256: 3658701c742308f9084248ae5c73d59fa770ce0499e5ba96f225731650ce9a37/)
  assert.match(doc, /rdsApplyCandidateSqlSha256: 84d86d895c3c26beb0dc3ec78951db577bfb782ac9d6d1a6f8c1d1716f355b38/)
  assert.match(doc, /validationSqlSha256: dc86e9d57099f78146577510bdc3f1a52949e0af327c12c15defaef28d12c3d5/)
  assert.match(doc, /rollbackChecklistSha256: 14556863a433cb4b1eed435e938700733d3b195693973b79fc984cfe2ff6f207/)
