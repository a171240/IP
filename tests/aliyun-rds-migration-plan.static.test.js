...
test("Aliyun RDS migration plan command is wired into scripts, predeploy, deploy spec, and artifacts", () => {
  ...
  assert.match(rdsDoc, /databaseUrlCnReferencedInSource: true/)
  assert.match(rdsDoc, /postgresDataAccessAdapterDetected: true/)
  assert.doesNotMatch(rdsDoc, /databaseUrlCnReferencedInSource: false/)
  assert.doesNotMatch(rdsDoc, /postgresDataAccessAdapterDetected: false/)
  assert.match(rdsDoc, /schemaSqlSha256: 7da2a25fd73733939bb799b912f86484ba954cb027b2046c44903d96b8b5b9d4/)
  assert.match(rdsDoc, /validationSqlSha256: 3975d5f2f7808bf51694b82ff8f817aa5fccff6d983a36c68de2c2a38d261d50/)
  assert.match(rdsDoc, /rollbackChecklistSha256: f2dbdf60cf7d6700d1b93ed66d9123ce089fa462b55be2f6188d502b11aa27dd/)
  assert.match(rdsDoc, /deploy\/aliyun-production-cn\.rds-migration\.local\.json/)
